...
def compare_astar_bfs(problem):
    wastar = WeightedAStarSearch(problem, weight=0, print_statistics=True,
                                 time_limit=180)
    wastar.run()
